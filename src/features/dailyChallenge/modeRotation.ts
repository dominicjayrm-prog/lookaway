...
// names_and_faces so the developer can play-test Phase 4 today
// instead of waiting for Tuesday. Revert this Monday entry to
// 'phone_number' before shipping production.
const ROTATION: Record<number, DailyChallengeModeId> = {
  0: 'phone_number',     // Sunday
  1: 'names_and_faces',  // Monday — TEMP QA OVERRIDE, revert to phone_number before prod
