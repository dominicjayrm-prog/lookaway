...
const LEVELS: Record<number, MastermindLevel> = {
  ...
  41: { level: 41, stageCount: 3, secondsPerStage: 2, stages: [
    ...
    questions: [{text:'Red circle changed to what colour in S2?',options:['Pink','Orange','Teal','Gold'],correctIndex:2},{text:'How many shapes were in the top row in S1?',options:['4','3','5','2'],correctIndex:0},{text:'Square and star swapped in S1→2?',options:['Only bottom row','No','Only top row','Yes'],correctIndex:3},{text:'Diamond colour in S3?',options:['Purple','Orange','Pink','Gold'],correctIndex:1},{text:'Bottom-row star colour in S3?',options:['Pink','Gold','Blue','Teal'],correctIndex:2},{text:'Triangle colour stayed the same all 3 stages?',options:['Only S2-S3','No','Only S1-S2','Yes'],correctIndex:3}]},
  ...
  42: { level: 42, stageCount: 3, secondsPerStage: 1.8, stages: [
    ...
    questions: [{text:'Red diamond moved to where in S2?',options:['Top-left','Bottom-right','Bottom-left','Top-right'],correctIndex:3},{text:'Top-left star colour in S2?',options:['Green','Red','Orange','Pink'],correctIndex:2},{text:'Circle colour in S3?',options:['Teal','Blue','Purple','Pink'],correctIndex:0},{text:'Diamond at top-right in S3 colour?',options:['Red','Gold','Purple','Pink'],correctIndex:3},{text:'Triangle moved up in S2→3?',options:['No','Yes','Only sideways','Removed'],correctIndex:1},{text:'How many stars total in S3?',options:['1','3','2','4'],correctIndex:2}]},
  ...
  43: { level: 43, stageCount: 4, secondsPerStage: 2, stages: [
    ...
    questions: [{text:'Star colour in S1?',options:['Blue','Teal','Red','Gold'],correctIndex:3,targetStage:1},{text:'Star and circle swapped in S1→2?',options:['Only top row','No','Yes','Only colours'],correctIndex:2},{text:'Star colour in S3?',options:['Gold','Teal','Pink','Red'],correctIndex:1,targetStage:3},{text:'Triangle colour in S4?',options:['Orange','Purple','Gold','Blue'],correctIndex:0,targetStage:4},{text:'Square colour in S4?',options:['Blue','Teal','Pink','Gold'],correctIndex:2,targetStage:4},{text:'How many shapes moved in S3→4?',options:['3','2','1','4'],correctIndex:0}]},
  ...
  44: { level: 44, stageCount: 4, secondsPerStage: 1.8, stages: [
    ...
    questions: [{text:'Triangle colour in S2?',options:['Purple','Gold','Orange','Pink'],correctIndex:2},{text:'Diamond colour in S3?',options:['Blue','Pink','Purple','Teal'],correctIndex:3},{text:'Star colour in S4?',options:['Red','Gold','Teal','Blue'],correctIndex:0},{text:'Red circle moved row in S1→2?',options:['No','Yes','Only sideways','Removed'],correctIndex:1},{text:'How many shapes are at the bottom row in S4?',options:['2','1','4','3'],correctIndex:3},{text:'Pink circle stayed at top-right in all 4 stages?',options:['No, moved S3','No, moved S2','Yes','No, moved S4'],correctIndex:0}]},
  ...
  45: { level: 45, stageCount: 4, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Square colour in S2?',options:['Teal','Blue','Pink','Purple'],correctIndex:1},{text:'Diamond colour in S3?',options:['Purple','Teal','Pink','Orange'],correctIndex:3},{text:'How many shapes moved in S3→4?',options:['2','3','4','5'],correctIndex:2},{text:'Top-left star colour in S4?',options:['Red','Gold','Teal','Pink'],correctIndex:0},{text:'Circle changed colour at any point?',options:['No','Yes'],correctIndex:1},{text:'Triangle moved at any point?',options:['Only S3→4','No','Only S2→3','Yes'],correctIndex:3}]},
  ...
  46: { level: 46, stageCount: 3, secondsPerStage: 2, stages: [
    ...
    questions: [{text:'Top-left circle exact colour in S2?',options:['Blue','Teal','Light Blue','Purple'],correctIndex:2,targetStage:2},{text:'Square colour in S3?',options:['Lavender','Purple','Blue','Pink'],correctIndex:0,targetStage:3},{text:'Bottom-right circle colour in S2?',options:['Purple','Blue','Pink','Lavender'],correctIndex:3,targetStage:2},{text:'Did the diamond change shade in S2→3?',options:['No','Yes','Only saturation','Only outline'],correctIndex:1},{text:'How many shapes shifted shade across all 3 stages?',options:['3','5','4','2'],correctIndex:2},{text:'Which shape stayed exactly the same colour?',options:['Diamond','Star','Square','Triangle'],correctIndex:3}]},
  ...
  47: { level: 47, stageCount: 4, secondsPerStage: 2, stages: [
    ...
    questions: [{text:'Top-left star colour in S2?',options:['Purple','Blue','Pink','Lavender'],correctIndex:3,targetStage:2},{text:'Top-circle colour in S3?',options:['Blue','Teal','Light Blue','Navy'],correctIndex:2,targetStage:3},{text:'Bottom-right star colour in S4?',options:['Light Blue','Purple','Blue','Pink'],correctIndex:1,targetStage:4},{text:'Did the diamond shift shade across stages?',options:['No','Yes'],correctIndex:0},{text:'How many shapes ended up at a NEW shade compared to S1?',options:['2','1','4','3'],correctIndex:3},{text:'Star at top-left changed shade in which transition?',options:['S2→3','S1→2','S3→4','None'],correctIndex:1}]},
  ...
  48: { level: 48, stageCount: 4, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Top-left circle in S1 — exact colour?',options:['Purple','Blue','Pink','Lavender'],correctIndex:3},{text:'Square colour in S3?',options:['Blue','Light Blue','Teal','Purple'],correctIndex:0},{text:'Bottom-right circle in S4 — exact shade?',options:['Blue','Teal','Light Blue','Purple'],correctIndex:2},{text:'Top-left circle alternated between which two shades?',options:['Blue-LightBlue','Purple-Lavender','Red-Pink','Gold-Orange'],correctIndex:1},{text:'How many shapes did NOT change at all?',options:['3','2','1','4'],correctIndex:2},{text:'Diamond colour in S4?',options:['Gold','Red','Pink','Orange'],correctIndex:3}]},
  ...
  49: { level: 49, stageCount: 5, secondsPerStage: 2, stages: [
    ...
    questions: [{text:'Star colour in S1?',options:['Red','Teal','Gold','Blue'],correctIndex:2,targetStage:1},{text:'Star and circle swapped in S1→2?',options:['Yes','No'],correctIndex:0},{text:'Star colour in S3?',options:['Gold','Red','Pink','Teal'],correctIndex:3,targetStage:3},{text:'Square colour in S3?',options:['Orange','Blue','Red','Pink'],correctIndex:0,targetStage:3},{text:'Triangle colour in S5?',options:['Purple','Blue','Gold','Teal'],correctIndex:2,targetStage:5},{text:'Diamond colour in S5?',options:['Green','Pink','Purple','Blue'],correctIndex:3,targetStage:5},{text:'How many shapes ended in different positions in S5 vs S1?',options:['3','4','5','6'],correctIndex:1}]},
  ...
  50: { level: 50, stageCount: 5, secondsPerStage: 1.8, stages: [
    ...
    questions: [{text:'Top-left diamond colour in S1?',options:['Teal','Pink','Purple','Blue'],correctIndex:3},{text:'Star moved to where in S2?',options:['Top-right','Top-left','Bottom-left','Bottom-right'],correctIndex:1},{text:'Triangle changed colour in which transition?',options:['S3→4','S2→3','S1→2','S4→5'],correctIndex:2},{text:'Circle colour in S3?',options:['Teal','Red','Pink','Blue'],correctIndex:0},{text:'Square colour in S4?',options:['Green','Red','Blue','Purple'],correctIndex:3},{text:'How many shapes are at the bottom row in S5?',options:['2','4','3','5'],correctIndex:2},{text:'Bottom-right diamond colour in S5?',options:['Blue','Pink','Purple','Red'],correctIndex:0}]},

  // L51: 4 stages × 1.5s, 6 shapes, all-twists combined, 6 questions
  51: { level: 51, stageCount: 4, secondsPerStage: 1.5, stages: [
    { shapes: [{id:'s1',type:'star',colour:'#0984E3',position:{x:20,y:20}},{id:'s2',type:'circle',colour:'#FF6B6B',position:{x:50,y:20}},{id:'s3',type:'diamond',colour:'#6C5CE7',position:{x:80,y:20}},{id:'s4',type:'triangle',colour:'#D4A012',position:{x:20,y:55}},{id:'s5',type:'square',colour:'#00B894',position:{x:50,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#3D9DEB',position:{x:50,y:20}},{id:'s2',type:'circle',colour:'#FF6B6B',position:{x:20,y:20}},{id:'s3',type:'diamond',colour:'#6C5CE7',position:{x:80,y:20}},{id:'s4',type:'triangle',colour:'#D4A012',position:{x:20,y:55}},{id:'s5',type:'square',colour:'#00B894',position:{x:50,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#3D9DEB',position:{x:50,y:20}},{id:'s2',type:'circle',colour:'#FF6B6B',position:{x:80,y:55}},{id:'s3',type:'diamond',colour:'#A29BFE',position:{x:80,y:20}},{id:'s4',type:'triangle',colour:'#D4A012',position:{x:20,y:55}},{id:'s5',type:'square',colour:'#00B894',position:{x:50,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:20,y:20}}]},
    { shapes: [{id:'s1',type:'star',colour:'#3D9DEB',position:{x:50,y:55}},{id:'s2',type:'circle',colour:'#FF9F43',position:{x:80,y:55}},{id:'s3',type:'diamond',colour:'#A29BFE',position:{x:80,y:20}},{id:'s4',type:'triangle',colour:'#0984E3',position:{x:50,y:20}},{id:'s5',type:'square',colour:'#00B894',position:{x:20,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:20,y:20}}]}],
    questions: [{text:'Top-left star colour in S2?',options:['Blue','Purple','Teal','Light Blue'],correctIndex:3},{text:'Diamond colour in S3?',options:['Purple','Blue','Lavender','Pink'],correctIndex:2},{text:'Circle colour in S4?',options:['Orange','Red','Pink','Gold'],correctIndex:0},{text:'Triangle colour in S4?',options:['Gold','Blue','Light Blue','Green'],correctIndex:1},{text:'How many shapes moved from S2→3?',options:['1','3','4','2'],correctIndex:3},{text:'Pink star alternated rows across stages?',options:['Only S1-2','No','Yes','Only S3-4'],correctIndex:2}]},

  // L52: 5 stages × 1.5s, 6 shapes, NO hints, 7 questions — apex cycle
  52: { level: 52, stageCount: 5, secondsPerStage: 1.5, stages: [
    { shapes: [{id:'s1',type:'circle',colour:'#FF6B6B',position:{x:18,y:20}},{id:'s2',type:'square',colour:'#0984E3',position:{x:50,y:20}},{id:'s3',type:'star',colour:'#D4A012',position:{x:82,y:20}},{id:'s4',type:'diamond',colour:'#6C5CE7',position:{x:18,y:55}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:82,y:55}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#FF6B6B',position:{x:50,y:20}},{id:'s2',type:'square',colour:'#0984E3',position:{x:18,y:20}},{id:'s3',type:'star',colour:'#D4A012',position:{x:82,y:20}},{id:'s4',type:'diamond',colour:'#6C5CE7',position:{x:18,y:55}},{id:'s5',type:'triangle',colour:'#FF9F43',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:82,y:55}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#FF6B6B',position:{x:50,y:20}},{id:'s2',type:'square',colour:'#00CEC9',position:{x:18,y:20}},{id:'s3',type:'star',colour:'#D4A012',position:{x:82,y:55}},{id:'s4',type:'diamond',colour:'#6C5CE7',position:{x:18,y:55}},{id:'s5',type:'triangle',colour:'#FF9F43',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:82,y:20}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#6C5CE7',position:{x:50,y:20}},{id:'s2',type:'square',colour:'#00CEC9',position:{x:82,y:55}},{id:'s3',type:'star',colour:'#D4A012',position:{x:18,y:20}},{id:'s4',type:'diamond',colour:'#0984E3',position:{x:18,y:55}},{id:'s5',type:'triangle',colour:'#FF9F43',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:82,y:20}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#6C5CE7',position:{x:82,y:55}},{id:'s2',type:'square',colour:'#00CEC9',position:{x:18,y:55}},{id:'s3',type:'star',colour:'#FD79A8',position:{x:18,y:20}},{id:'s4',type:'diamond',colour:'#0984E3',position:{x:50,y:55}},{id:'s5',type:'triangle',colour:'#FF9F43',position:{x:50,y:20}},{id:'s6',type:'circle',colour:'#FF6B6B',position:{x:82,y:20}}]}],
    questions: [{text:'Red circle colour in S4?',options:['Red','Blue','Pink','Purple'],correctIndex:3},{text:'Square colour in S3?',options:['Blue','Light Blue','Teal','Purple'],correctIndex:2},{text:'Triangle colour in S2?',options:['Orange','Green','Gold','Blue'],correctIndex:0},{text:'Star colour in S5?',options:['Gold','Pink','Red','Teal'],correctIndex:1},{text:'How many shapes are in the top row in S5?',options:['2','1','4','3'],correctIndex:3},{text:'Diamond colour in S4?',options:['Blue','Purple','Teal','Pink'],correctIndex:0},{text:'Pink circle alternated rows in S2→3?',options:['Yes','No'],correctIndex:0}]},

  // L53: 4 stages × 1.5s, 6 shapes, NO hints, subtle colours + transformation chain
  53: { level: 53, stageCount: 4, secondsPerStage: 1.5, stages: [
    { shapes: [{id:'s1',type:'star',colour:'#0984E3',position:{x:20,y:20}},{id:'s2',type:'circle',colour:'#6C5CE7',position:{x:50,y:20}},{id:'s3',type:'square',colour:'#D4A012',position:{x:80,y:20}},{id:'s4',type:'diamond',colour:'#00B894',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#FF6B6B',position:{x:50,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#3D9DEB',position:{x:80,y:20}},{id:'s2',type:'circle',colour:'#A29BFE',position:{x:50,y:20}},{id:'s3',type:'square',colour:'#D4A012',position:{x:20,y:20}},{id:'s4',type:'diamond',colour:'#00B894',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#FF6B6B',position:{x:50,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#3D9DEB',position:{x:80,y:55}},{id:'s2',type:'circle',colour:'#A29BFE',position:{x:50,y:20}},{id:'s3',type:'square',colour:'#FF9F43',position:{x:20,y:20}},{id:'s4',type:'diamond',colour:'#00B894',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#FF6B6B',position:{x:50,y:55}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:80,y:20}}]},
    { shapes: [{id:'s1',type:'star',colour:'#0984E3',position:{x:80,y:55}},{id:'s2',type:'circle',colour:'#6C5CE7',position:{x:20,y:55}},{id:'s3',type:'square',colour:'#FF9F43',position:{x:20,y:20}},{id:'s4',type:'diamond',colour:'#00CEC9',position:{x:50,y:20}},{id:'s5',type:'triangle',colour:'#FF6B6B',position:{x:80,y:20}},{id:'s6',type:'star',colour:'#FD79A8',position:{x:50,y:55}}]}],
    questions: [{text:'Top star alternated between which two shades?',options:['Red-Pink','Purple-Lavender','Blue-LightBlue','Gold-Orange'],correctIndex:2},{text:'Circle alternated between?',options:['Gold-Orange','Blue-LightBlue','Red-Pink','Purple-Lavender'],correctIndex:3},{text:'Square colour in S3?',options:['Gold','Orange','Red','Pink'],correctIndex:1},{text:'Diamond colour in S4?',options:['Teal','Green','Blue','Purple'],correctIndex:0},{text:'Triangle moved at all in S1→4?',options:['Only S4','No','Only S2','Yes'],correctIndex:3},{text:'How many shapes are at top row in S4?',options:['2','4','3','1'],correctIndex:2}]},

  // L54: 5 stages × 1.5s, 6 shapes, NO hints, every twist — pre-boss
  54: { level: 54, stageCount: 5, secondsPerStage: 1.5, stages: [
    { shapes: [{id:'s1',type:'circle',colour:'#0984E3',position:{x:20,y:20}},{id:'s2',type:'square',colour:'#FF6B6B',position:{x:50,y:20}},{id:'s3',type:'star',colour:'#D4A012',position:{x:80,y:20}},{id:'s4',type:'diamond',colour:'#6C5CE7',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#3D9DEB',position:{x:50,y:20}},{id:'s2',type:'square',colour:'#FF6B6B',position:{x:20,y:20}},{id:'s3',type:'star',colour:'#D4A012',position:{x:80,y:20}},{id:'s4',type:'diamond',colour:'#A29BFE',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#3D9DEB',position:{x:50,y:55}},{id:'s2',type:'square',colour:'#FF6B6B',position:{x:20,y:20}},{id:'s3',type:'star',colour:'#FF9F43',position:{x:80,y:20}},{id:'s4',type:'diamond',colour:'#A29BFE',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:50,y:20}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:80,y:55}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#0984E3',position:{x:50,y:55}},{id:'s2',type:'square',colour:'#FD79A8',position:{x:20,y:20}},{id:'s3',type:'star',colour:'#FF9F43',position:{x:80,y:55}},{id:'s4',type:'diamond',colour:'#A29BFE',position:{x:20,y:55}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:50,y:20}},{id:'s6',type:'circle',colour:'#FF6B6B',position:{x:80,y:20}}]},
    { shapes: [{id:'s1',type:'circle',colour:'#0984E3',position:{x:80,y:55}},{id:'s2',type:'square',colour:'#FD79A8',position:{x:50,y:20}},{id:'s3',type:'star',colour:'#FF9F43',position:{x:20,y:55}},{id:'s4',type:'diamond',colour:'#6C5CE7',position:{x:20,y:20}},{id:'s5',type:'triangle',colour:'#00CEC9',position:{x:50,y:55}},{id:'s6',type:'circle',colour:'#FF6B6B',position:{x:80,y:20}}]}],
    questions: [{text:'Top-left circle in S2 — exact shade?',options:['Blue','Teal','Light Blue','Purple'],correctIndex:2},{text:'Diamond shade alternated between?',options:['Gold-Orange','Blue-LightBlue','Red-Pink','Purple-Lavender'],correctIndex:3},{text:'Square colour in S4?',options:['Pink','Red','Orange','Gold'],correctIndex:0},{text:'Star colour in S5?',options:['Gold','Orange','Red','Yellow'],correctIndex:1},{text:'Triangle colour in S5?',options:['Green','Lavender','Blue','Teal'],correctIndex:3},{text:'How many shapes moved positions in S4→5?',options:['2','4','3','5'],correctIndex:1},{text:'Pink circle started at top-right and ended at?',options:['Top-right','Top-left','Top-right (after moving)','Bottom-left'],correctIndex:2}]},

  // L55 (pos 400): GRAND MASTER FINAL — 5 stages × 1.5s, 7 shapes/stage, 8 questions
  // Every cognitive lever combined: 5-stage compression, no hints, subtle colours,
  // transformation chains, multi-attribute changes, dense 7-shape layout.
  // This is the apex of the entire game's difficulty curve.
  55: { level: 55, stageCount: 5, secondsPerStage: 1.5, stages: [
    { shapes: [{id:'s1',type:'star',colour:'#D4A012',position:{x:18,y:18}},{id:'s2',type:'circle',colour:'#0984E3',position:{x:40,y:18}},{id:'s3',type:'diamond',colour:'#6C5CE7',position:{x:62,y:18}},{id:'s4',type:'square',colour:'#FF6B6B',position:{x:82,y:18}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:25,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:50,y:55}},{id:'s7',type:'star',colour:'#FF9F43',position:{x:75,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#D4A012',position:{x:40,y:18}},{id:'s2',type:'circle',colour:'#3D9DEB',position:{x:18,y:18}},{id:'s3',type:'diamond',colour:'#A29BFE',position:{x:62,y:18}},{id:'s4',type:'square',colour:'#FF6B6B',position:{x:82,y:18}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:25,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:75,y:55}},{id:'s7',type:'star',colour:'#FF9F43',position:{x:50,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#00CEC9',position:{x:40,y:18}},{id:'s2',type:'circle',colour:'#3D9DEB',position:{x:18,y:55}},{id:'s3',type:'diamond',colour:'#A29BFE',position:{x:62,y:18}},{id:'s4',type:'square',colour:'#FF9F43',position:{x:82,y:18}},{id:'s5',type:'triangle',colour:'#00B894',position:{x:25,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:75,y:55}},{id:'s7',type:'star',colour:'#FF6B6B',position:{x:50,y:55}}]},
    { shapes: [{id:'s1',type:'star',colour:'#00CEC9',position:{x:82,y:18}},{id:'s2',type:'circle',colour:'#0984E3',position:{x:18,y:55}},{id:'s3',type:'diamond',colour:'#6C5CE7',position:{x:62,y:55}},{id:'s4',type:'square',colour:'#FF9F43',position:{x:40,y:18}},{id:'s5',type:'triangle',colour:'#D4A012',position:{x:25,y:55}},{id:'s6',type:'circle',colour:'#FD79A8',position:{x:75,y:55}},{id:'s7',type:'star',colour:'#FF6B6B',position:{x:62,y:18}}]},
    { shapes: [{id:'s1',type:'star',colour:'#00CEC9',position:{x:82,y:55}},{id:'s2',type:'circle',colour:'#0984E3',position:{x:50,y:55}},{id:'s3',type:'diamond',colour:'#6C5CE7',position:{x:18,y:55}},{id:'s4',type:'square',colour:'#FD79A8',position:{x:40,y:18}},{id:'s5',type:'triangle',colour:'#D4A012',position:{x:25,y:55}},{id:'s6',type:'circle',colour:'#FF6B6B',position:{x:75,y:55}},{id:'s7',type:'star',colour:'#FF9F43',position:{x:62,y:18}}]}],
    questions: [{text:'Gold star colour in S3?',options:['Gold','Pink','Red','Teal'],correctIndex:3},{text:'Top circle in S1 — exact shade?',options:['Teal','Light Blue','Blue','Purple'],correctIndex:2},{text:'Top circle in S2 — exact shade?',options:['Light Blue','Blue','Teal','Purple'],correctIndex:0},{text:'Diamond shade in S2?',options:['Purple','Blue','Pink','Lavender'],correctIndex:3},{text:'Square colour in S5?',options:['Red','Pink','Orange','Gold'],correctIndex:1},{text:'Triangle colour in S4?',options:['Green','Teal','Gold','Pink'],correctIndex:2},{text:'How many shapes are at the bottom row in S5?',options:['5','4','3','6'],correctIndex:0},{text:'Coral star (s7) colour in S3?',options:['Orange','Gold','Pink','Red'],correctIndex:3}]},
