...
const LEVELS: Record<number, MastermindLevel> = {
  ...
  51: { level: 51, stageCount: 4, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Top-left star colour in S2?',options:['Blue','Light Blue','Teal','Purple'],correctIndex:1},{text:'Diamond colour in S3?',options:['Purple','Lavender','Blue','Pink'],correctIndex:1},{text:'Circle colour in S4?',options:['Red','Orange','Pink','Gold'],correctIndex:1},{text:'Triangle colour in S4?',options:['Gold','Blue','Light Blue','Green'],correctIndex:1},{text:'How many shapes moved from S2→3?',options:['2','3','4','1'],correctIndex:0},{text:'Pink star alternated rows across stages?',options:['Yes','No','Only S1-2','Only S3-4'],correctIndex:0}]},
  ...
  52: { level: 52, stageCount: 5, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Red circle colour in S4?',options:['Red','Purple','Pink','Blue'],correctIndex:1},{text:'Square colour in S3?',options:['Blue','Teal','Light Blue','Purple'],correctIndex:1},{text:'Triangle colour in S2?',options:['Green','Orange','Gold','Blue'],correctIndex:1},{text:'Star colour in S5?',options:['Gold','Pink','Red','Teal'],correctIndex:1},{text:'How many shapes are in the top row in S5?',options:['2','3','4','1'],correctIndex:1},{text:'Diamond colour in S4?',options:['Purple','Blue','Teal','Pink'],correctIndex:1},{text:'Pink circle alternated rows in S2→3?',options:['Yes','No'],correctIndex:0}]},
  ...
  53: { level: 53, stageCount: 4, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Top star alternated between which two shades?',options:['Blue-LightBlue','Purple-Lavender','Red-Pink','Gold-Orange'],correctIndex:0},{text:'Circle alternated between?',options:['Purple-Lavender','Blue-LightBlue','Red-Pink','Gold-Orange'],correctIndex:0},{text:'Square colour in S3?',options:['Gold','Orange','Red','Pink'],correctIndex:1},{text:'Diamond colour in S4?',options:['Green','Teal','Blue','Purple'],correctIndex:1},{text:'Triangle moved at all in S1→4?',options:['Yes','No','Only S2','Only S4'],correctIndex:0},{text:'How many shapes are at top row in S4?',options:['2','3','4','1'],correctIndex:1}]},
  ...
  54: { level: 54, stageCount: 5, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Top-left circle in S2 — exact shade?',options:['Blue','Light Blue','Teal','Purple'],correctIndex:1},{text:'Diamond shade alternated between?',options:['Purple-Lavender','Blue-LightBlue','Red-Pink','Gold-Orange'],correctIndex:0},{text:'Square colour in S4?',options:['Red','Pink','Orange','Gold'],correctIndex:1},{text:'Star colour in S5?',options:['Gold','Orange','Red','Yellow'],correctIndex:1},{text:'Triangle colour in S5?',options:['Green','Teal','Blue','Lavender'],correctIndex:1},{text:'How many shapes moved positions in S4→5?',options:['2','3','4','5'],correctIndex:2},{text:'Pink circle started at top-right and ended at?',options:['Top-right','Top-left','Bottom-left','Top-right (after moving)'],correctIndex:3}]},
  ...
  55: { level: 55, stageCount: 5, secondsPerStage: 1.5, stages: [
    ...
    questions: [{text:'Gold star colour in S3?',options:['Gold','Teal','Red','Pink'],correctIndex:1},{text:'Top circle in S1 — exact shade?',options:['Blue','Light Blue','Teal','Purple'],correctIndex:0},{text:'Top circle in S2 — exact shade?',options:['Blue','Light Blue','Teal','Purple'],correctIndex:1},{text:'Diamond shade in S2?',options:['Purple','Lavender','Pink','Blue'],correctIndex:1},{text:'Square colour in S5?',options:['Red','Orange','Pink','Gold'],correctIndex:2},{text:'Triangle colour in S4?',options:['Green','Gold','Teal','Pink'],correctIndex:1},{text:'How many shapes are at the bottom row in S5?',options:['3','4','5','6'],correctIndex:2},{text:'Coral star (s7) colour in S3?',options:['Orange','Red','Pink','Gold'],correctIndex:1}]},
