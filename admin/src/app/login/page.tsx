  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-lg">
        <div className="mb-8 text-center"><h1 className="text-2xl font-bold tracking-tight text-slate-900">BLANKED</h1><span className="mt-1 inline-block rounded-full bg-slate-100 px-3 py-0.5 text-xs font-medium text-slate-500">Admin</span></div>
