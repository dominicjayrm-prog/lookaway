...
export interface LibraryItem {
  ...
  name: string;
  category: string;
  render: (color: string, size: number) => React.ReactElement;
}

export const objectCategories = [
  { id: 'basic', name: 'Basic Shapes', color: '#6C5CE7', count: 15 },
  { id: 'numbers', name: 'Numbers', color: '#0984E3', count: 9 },
  { id: 'letters', name: 'Letters', color: '#00B894', count: 26 },
  { id: 'everyday', name: 'Everyday Objects', color: '#E17055', count: 15 },
  { id: 'animals', name: 'Animals', color: '#43A047', count: 10 },
  { id: 'food', name: 'Food & Drink', color: '#E53935', count: 10 },
  { id: 'patterns', name: 'Patterns & Special', color: '#7E57C2', count: 6 },
];

export const CATEGORIES = objectCategories.map(c => c.name);

// ═══════════════════════════════════════════════════════════
// BASIC SHAPES — 15 items
// ═══════════════════════════════════════════════════════════
const basicShapes: LibraryItem[] = [
  { id: 'circle', name: 'Circle', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><circle cx="50" cy="50" r="44" fill={c}/></svg> },
  { id: 'square', name: 'Square', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><rect x="8" y="8" width="84" height="84" rx="6" fill={c}/></svg> },
  { id: 'triangle', name: 'Triangle', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="50,8 92,88 8,88" fill={c}/></svg> },
  { id: 'star', name: 'Star', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="50,5 63,35 95,35 69,57 79,90 50,70 21,90 31,57 5,35 37,35" fill={c}/></svg> },
  { id: 'diamond', name: 'Diamond', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="50,5 95,50 50,95 5,50" fill={c}/></svg> },
  { id: 'hexagon', name: 'Hexagon', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="50,5 93,27 93,73 50,95 7,73 7,27" fill={c}/></svg> },
  { id: 'pentagon', name: 'Pentagon', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="50,5 97,38 79,92 21,92 3,38" fill={c}/></svg> },
  { id: 'oval', name: 'Oval', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><ellipse cx="50" cy="50" rx="44" ry="30" fill={c}/></svg> },
  { id: 'semicircle', name: 'Semicircle', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><path d="M8,55 A42,42 0 0,1 92,55 Z" fill={c}/></svg> },
  { id: 'ring', name: 'Ring', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" fill="none" stroke={c} strokeWidth="10"/></svg> },
  { id: 'cross', name: 'Cross', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><path d="M38,8 h24 v30 h30 v24 h-30 v30 h-24 v-30 h-30 v-24 h30 z" fill={c}/></svg> },
  { id: 'heart', name: 'Heart', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><path d="M50,88 C20,65 5,50 5,32 C5,18 16,8 30,8 C38,8 45,12 50,20 C55,12 62,8 70,8 C84,8 95,18 95,32 C95,50 80,65 50,88Z" fill={c}/></svg> },
  { id: 'crescent', name: 'Crescent', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><circle cx="42" cy="50" r="36" fill={c}/><circle cx="62" cy="44" r="30" fill="white"/></svg> },
  { id: 'arrow_right', name: 'Arrow Right', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="10,35 60,35 60,15 90,50 60,85 60,65 10,65" fill={c}/></svg> },
  { id: 'arrow_up', name: 'Arrow Up', category: 'Basic Shapes', render: (c, s) => <svg width={s} height={s} viewBox="0 0 100 100"><polygon points="50,10 85,60 65,60 65,90 35,90 35,60 15,60" fill={c}/></svg> },
];

// ═══════════════════════════════════════════════════════════
// NUMBERS — 9 items
// ═══════════════════════════════════════════════════════════
const numbers: LibraryItem[] = [1,2,3,4,5,6,7,8,9].map(n => ({
  id: `number_${n}`, name: `${n}`, category: 'Numbers',
  render: (c: string, s: number) => (
...
// LETTERS — 26 items
// ═══════════════════════════════════════════════════════════
const letters: LibraryItem[] = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.split('').map(l => ({
  id: `letter_${l}`, name: l, category: 'Letters',
  render: (c: string, s: number) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
...
// ═══════════════════════════════════════════════════════════
const everyday: LibraryItem[] = [
  { id: 'apple', name: 'Apple', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'tree', name: 'Tree', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'house', name: 'House', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'car', name: 'Car', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'key', name: 'Key', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'book', name: 'Book', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'cup', name: 'Cup', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'clock', name: 'Clock', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'umbrella', name: 'Umbrella', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'phone', name: 'Phone', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'lightbulb', name: 'Light Bulb', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'flower', name: 'Flower', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'sun', name: 'Sun', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'cloud', name: 'Cloud', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'moon_obj', name: 'Moon', category: 'Everyday Objects', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
...
// ANIMALS — 10 items
// ═══════════════════════════════════════════════════════════
const animals: LibraryItem[] = [
  { id: 'cat', name: 'Cat', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'dog', name: 'Dog', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'fish', name: 'Fish', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'bird', name: 'Bird', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'butterfly', name: 'Butterfly', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'rabbit', name: 'Rabbit', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'frog', name: 'Frog', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'ladybug', name: 'Ladybug', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'turtle', name: 'Turtle', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'bee', name: 'Bee', category: 'Animals', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
...
// FOOD & DRINK — 10 items
// ═══════════════════════════════════════════════════════════
const food: LibraryItem[] = [
  { id: 'pizza', name: 'Pizza', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'cake', name: 'Cake', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'cookie', name: 'Cookie', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'icecream', name: 'Ice Cream', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'donut', name: 'Donut', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'watermelon', name: 'Watermelon', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'cherry', name: 'Cherry', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'coffee', name: 'Coffee', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'banana', name: 'Banana', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'lemon', name: 'Lemon', category: 'Food & Drink', render: (_c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
...
// ═══════════════════════════════════════════════════════════
// PATTERNS & SPECIAL — 6 items
// ═══════════════════════════════════════════════════════════
const patterns: LibraryItem[] = [
  { id: 'bullseye', name: 'Bullseye', category: 'Patterns & Special', render: (c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
      <circle cx="50" cy="50" r="44" fill={c} />
  ...
  { id: 'half_half', name: 'Half and Half', category: 'Patterns & Special', render: (c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
      <circle cx="50" cy="50" r="44" fill="#1E88E5" />
      <path d="M50,6 A44,44 0 0,1 50,94 Z" fill={c} />
    </svg>
  )},
  { id: 'striped_circle', name: 'Striped', category: 'Patterns & Special', render: (c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
      <circle cx="50" cy="50" r="44" fill={c} />
  ...
  { id: 'checkerboard', name: 'Checker', category: 'Patterns & Special', render: (c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
      <rect width="100" height="100" rx="8" fill="white" />
      {[0,1,2,3].map(r => [0,1,2,3].map(col => (r + col) % 2 === 0 ? <rect key={`${r}${col}`} x={10 + col * 20} y={10 + r * 20} width="20" height="20" fill={c} /> : null))}
    </svg>
  )},
  { id: 'spiral', name: 'Spiral', category: 'Patterns & Special', render: (c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
  ...
  { id: 'wave', name: 'Wave', category: 'Patterns & Special', render: (c, s) => (
    <svg width={s} height={s} viewBox="0 0 100 100">
...
// ═══════════════════════════════════════════════════════════
// COMBINED LIBRARY — 91 items total
// ═══════════════════════════════════════════════════════════
...
export function getObjectById(id: string): LibraryItem | undefined { return objectLibrary.find(o => o.id === id); }
export function getObjectsByCategory(cat: string): LibraryItem[] { return objectLibrary.filter(o => o.category === cat); }
